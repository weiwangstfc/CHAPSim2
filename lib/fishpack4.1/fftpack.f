...
C             WHERE
C
C                  C(K) = 0.5_WP*CMPLX(A(K),-B(K))   FOR K=1,...,KMAX
C
C                  C(-K) = CONJG(C(K))
C
C                  C(0) = AZERO
...
C     OUTPUT PARAMETER
C
C     WSAVE   A WORK ARRAY WITH AT LEAST INT(20.5_WP*N+15) LOCATIONS.
...
C
C
C     WSAVE   A WORK ARRAY WITH DIMENSION AT LEAST INT(20.5_WP*N+15)
...
C **********************************************************************
      ...
      INTEGER(4), INTENT(IN) :: N
      REAL(WP), INTENT(INOUT)  :: WAR(*)
      REAL(WP), INTENT(INOUT)  :: WAS(*)
      REAL(WP), INTENT(INOUT)  :: XH(*)
      REAL(WP), INTENT(INOUT)  :: X(*)
      REAL(WP), INTENT(INOUT)  :: IFAC(*)

      DATA SQRT3 /1.73205080756888_WP/
  ...
  104 CONTINUE
      MODN = MOD(N,2)
      IF (MODN .NE. 0) X(NS2+2) = 4._WP*XH(NS2+1)
...
C **********************************************************************
      ...
      DATA TSQRT2 /2.82842712474619_WP/
C
      IF (N-2) 101,102,103
  101 X(1) = 4._WP*X(1)
      RETURN
  102 X1 = 4._WP*(X(1)+X(2))
      X(2) = TSQRT2*(X(1)-X(2))
      X(1) = X1
      RETURN
...
C **********************************************************************
      SUBROUTINE PASSB2 (IDO,L1,CC,CH,WA1)
        ...
        INTEGER(4), INTENT(IN) :: IDO, L1
        REAL(WP), INTENT(INOUT)  :: CC(IDO,2,L1)
        REAL(WP), INTENT(INOUT)  :: CH(IDO,L1,2)
        REAL(WP), INTENT(INOUT)  :: WA1(1)
...
C **********************************************************************
      SUBROUTINE PASSB3 (IDO,L1,CC,CH,WA1,WA2)
        ...
        INTEGER(4), INTENT(IN) :: IDO, L1
        REAL(WP), INTENT(INOUT)  :: CC(IDO,3,L1)
        REAL(WP), INTENT(INOUT)  :: CH(IDO,L1,3)
        REAL(WP), INTENT(INOUT)  :: WA1(*), WA2(*)

      DATA TAUR,TAUI /-0.5_WP,0.866025403784439_WP/
...
C **********************************************************************
      SUBROUTINE PASSB4 (IDO,L1,CC,CH,WA1,WA2,WA3)
        ...
        INTEGER(4), INTENT(IN) :: IDO, L1
        REAL(WP), INTENT(INOUT)  :: CC(IDO,4,L1)
        REAL(WP), INTENT(INOUT)  :: CH(IDO,L1,4)
        REAL(WP), INTENT(INOUT)  :: WA1(*), WA2(*), WA3(*)
...
C **********************************************************************
      SUBROUTINE PASSB5 (IDO,L1,CC,CH,WA1,WA2,WA3,WA4)
        ...
        INTEGER(4), INTENT(IN) :: IDO, L1
        REAL(WP), INTENT(INOUT)  :: CC(IDO,5,L1)
        REAL(WP), INTENT(INOUT)  :: CH(IDO,L1,5)
        REAL(WP), INTENT(INOUT)  :: WA1(*), WA2(*), WA3(*), WA4(*)


        TR11 = 0.309016994374947_WP
        TI11 = 0.951056516295154_WP
        TR12 = -0.809016994374947_WP
        TI12 = 0.587785252292473_WP
...
C **********************************************************************
      SUBROUTINE PASSB (NAC,IDO,IP,L1,IDL1,CC,C1,C2,CH,CH2,WA)
        ...
        INTEGER(4), INTENT(IN) :: IDO,IP,L1,IDL1
        INTEGER(4), INTENT(INOUT) :: NAC
        REAL(WP), INTENT(INOUT)  :: CC(IDO,IP,L1)
...
C **********************************************************************
      SUBROUTINE PASSF5 (IDO,L1,CC,CH,WA1,WA2,WA3,WA4)
        ...
        TR11 = .309016994374947_WP
        TI11 = -.951056516295154_WP
        TR12 = -.809016994374947_WP
        TI12 = -.587785252292473_WP
...
C **********************************************************************
      ...
      DATA SQRT2 /1.414213562373095_WP/
      DO 101 K=1,L1
...
C **********************************************************************
      ...
      DATA TR11,TI11,TR12,TI12 /.309016994374947_WP,.951056516295154_WP,
     1 -.809016994374947_WP,.587785252292473_WP/
      DO 101 K=1,L1
...
C **********************************************************************
      SUBROUTINE RADF2 (IDO,L1,CC,CH,WA1)
        ...
        INTEGER(4), INTENT(IN) :: IDO,L1
        REAL(WP), INTENT(INOUT) :: CH(IDO,2,L1)
        REAL(WP), INTENT(INOUT) :: CC(IDO,L1,2)
        REAL(WP), INTENT(INOUT) :: WA1(*)
...
C **********************************************************************
      SUBROUTINE RADF3 (IDO,L1,CC,CH,WA1,WA2)
        ...
        INTEGER(4), INTENT(IN) :: IDO,L1
        REAL(WP), INTENT(INOUT) :: CH(IDO,3,L1)
        REAL(WP), INTENT(INOUT) :: CC(IDO,L1,3)
        REAL(WP), INTENT(INOUT) :: WA1(*),WA2(*)

      DATA TAUR,TAUI /-0.5_WP,.866025403784439_WP/
      DO 101 K=1,L1
...
C **********************************************************************
      SUBROUTINE RADF4 (IDO,L1,CC,CH,WA1,WA2,WA3)
        ...
        INTEGER(4), INTENT(IN) :: IDO,L1
        REAL(WP), INTENT(INOUT) :: CC(IDO,L1,4)
        REAL(WP), INTENT(INOUT) :: CH(IDO,4,L1)
        REAL(WP), INTENT(INOUT) :: WA1(*),WA2(*),WA3(*)

      DATA HSQT2 /.7071067811865475_WP/
      DO 101 K=1,L1
...
C **********************************************************************
      SUBROUTINE RADF5 (IDO,L1,CC,CH,WA1,WA2,WA3,WA4)
        ...
        INTEGER(4), INTENT(IN)  :: IDO,L1
        REAL(WP), INTENT(INOUT) :: CC(IDO,L1,5)
        REAL(WP), INTENT(INOUT) :: CH(IDO,5,L1)
        REAL(WP), INTENT(INOUT) :: WA1(*),WA2(*),WA3(*),WA4(*)
