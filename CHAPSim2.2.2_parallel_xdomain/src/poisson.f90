...
!     end do
    ...
    if (istret == ISTRET_NO) then 
       ...
       if (istret.ne.ISTRET_BOTTOM) then
          cw2(:,:,:)=0.;cw2c(:,:,:)=0.
          do k = sp%yst(3), sp%yen(3)
             do j = 1,ny/2
                do i = sp%yst(1), sp%yen(1)
  ...
  subroutine waves (d)
   ...
   !  USE param
    ...
    zkz(:)=0. ; zk2(:)=0.
      ...
      bcix    = d1rC2C(3, 2, IBC_PERIODIC) * FOUR / dx
      alcaix6 = d1fC2C(3, 1, IBC_PERIODIC)
    ...
    !WAVE NUMBER IN Y
      ...
      bciy    = d1rC2C(3, 2, IBC_PERIODIC) * FOUR / dy
      alcaiy6 = d1fC2C(3, 1, IBC_PERIODIC)
    ...
    !WAVE NUMBER IN Z
      ...
      bciz    = d1rC2C(3, 2, IBC_PERIODIC) * FOUR / dz
      alcaiz6 = d1fC2C(3, 1, IBC_PERIODIC)
    if (bcz==0) then
       do k=1,nz/2+1
          w=2.*pi*(k-1)/nz
