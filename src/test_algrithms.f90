...
!---------------------------------------------------------------------------------------------------------- 
      ...
      if(icase == ICASE_BURGERS1D_INVISCID) then
        call Get_x_midp_P2C_3D         (fl%qx, qx_ccc, dm, dm%ibcx(:, 1), dm%fbcx_qx(:, :, :))
...
!---------------------------------------------------------------------------------------------------------- 
      ...
      if(icase == ICASE_BURGERS1D_VISCOUS) then
        ...
        call Get_x_1st_derivative_P2C_3D( fl%qx, qx_ccc, dm, dm%ibcx(:, 1), dm%fbcx_qx(:, :, :) )
        call Get_x_1st_derivative_C2P_3D( qx_ccc, mx_rhs, dm, dm%ibcx(:, 1), dm%fbcx_qx(:, :, :) )
...
!---------------------------------------------------------------------------------------------------------- 
      ...
      if(icase == ICASE_BURGERS1D_INVISCID) then
        call Get_y_midp_P2C_3D         (qy_ypencil, qy_ccc_ypencil, dm, dm%ibcy(:, 1), dm%fbcy_qy(:, :, :))
...
!---------------------------------------------------------------------------------------------------------- 
      if(icase == ICASE_BURGERS1D_WAVEPROPAGATION) then
        call Get_y_midp_P2C_3D         (qy_ypencil, qy_ccc_ypencil, dm, dm%ibcy(:, 2), dm%fbcy_qy(:, :, :))
