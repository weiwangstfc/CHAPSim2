...
!----------------------------------------------------------------------------------------------------------
    div0 = ZERO
    call Get_x_1st_derivative_P2C_3D(ux, div0, dm, dm%iAccuracy, dm%ibcx_qx(:, IBC_PCC))
    div(:, :, :) = div(:, :, :) + div0(:, :, :)
...
!----------------------------------------------------------------------------------------------------------
    ...
    call Get_z_1st_derivative_P2C_3D(uz_zpencil, div0_zpencil, dm, dm%iAccuracy, dm%ibcz_qz(:, IBC_CCP))
